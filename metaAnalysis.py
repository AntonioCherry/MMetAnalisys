...
# Carica l'OneHotEncoder per le colonne categoriche
encoder = joblib.load("Encoders/one_hot_encoder.pkl")

# Codifica le colonne categoriche nel dataset di test
...
# Carica il modello RandomForest addestrato
model = joblib.load("Models/modello_meta.pkl")

# Fai predizioni sul dataset di test
...
# Generazione della ROC Curve multi-classe
